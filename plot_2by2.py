...
with open(sys.argv[1]) as f:
    for line in f:
        ...
        p1_x.append(float(line_split[0]))
        p1_y.append(float(line_split[1]))
...
with open(sys.argv[2]) as f:
    for line in f:
        line_split = line.split(",")
        p2_x.append(float(line_split[0]))
        p2_y.append(float(line_split[1]))
...
with open(sys.argv[3]) as f:
    for line in f:
        line_split = line.split(",")
        p3_x.append(float(line_split[0]))
        p3_y.append(float(line_split[1]))
...
with open(sys.argv[4]) as f:
    for line in f:
        line_split = line.split(",")
        p4_x.append(float(line_split[0]))
        p4_y.append(float(line_split[1]))

# Data for plot (hardcoded because this is for one special purpose)

x = [p1_x, p2_x, p3_x, p4_x]
y = [p1_y, p2_y, p3_y, p4_y]
titles = ["Semantic Links 1000-10000", "Semantic Links 1000-20000", "Etymological Links 1000-10000",
          "Etymological Links 1000-20000"]
